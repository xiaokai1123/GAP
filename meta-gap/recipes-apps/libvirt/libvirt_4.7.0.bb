...
DEPENDS = "bridge-utils gnutls libxml2 lvm2 avahi parted curl libpcap util-linux e2fsprogs pm-utils \
	   iptables readline libtasn1 libxslt-native acl libdevmapper libtirpc \
...
RDEPENDS_libvirt-libvirtd += "bridge-utils iptables pm-utils netcat-openbsd"
...
#INITSCRIPT_PARAMS_${PN}-libvirtd = "remove"
